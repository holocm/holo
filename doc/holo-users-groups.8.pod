...
definition file. For example:
    ...
    diff --holo target/tmp/holo/users-groups/user:wrongshell/expected.toml target/tmp/holo/users-groups/user:wrongshell/actual.toml
    --- target/tmp/holo/users-groups/user:wrongshell/expected.toml
